// В этом классе (и еще в MyServer и BaseAuthService) решение п.1 и п.4 ДЗ 6 урока. Другие классы по чату относительно 3 урока не менялись,
    ...
    class GetThread implements Runnable {
        ...
        public void readMessages(Exchanger<String> stringExchanger) throws IOException, InterruptedException {
            ...
            while (true) {
                ...
                logger.info("от " + name + ": " + strFromClient);           // логирование сообщений
